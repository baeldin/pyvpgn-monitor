...
def backup():
    ...
    for folder, subfolders, files in os.walk("/home/d2esr/pvpgn/var/pvpgn/charsave"):
        for file in files:
            if not '.log' in file:
                backup_archive.write(
                    os.path.join(folder, file),
                    os.path.relpath(os.path.join(folder, file), '/home/d2esr/pvpgn/var/pvpgn/charsave'),
